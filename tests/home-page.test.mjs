...
test('home interaction messages expose the compact mark-all-read action', async () => {
  ...
  assert.match(component, /wx:if="\{\{compact && compactExpanded\}\}" class="notification-mark-all-read__dismiss" catchtap="onCompactDismissTap"/)
  ...
  assert.match(componentStyles, /notification-mark-all-read--compact \{[\s\S]*width: 48rpx;[\s\S]*height: 48rpx;[\s\S]*padding: 0;[\s\S]*border-radius: 50%;/)
  assert.match(componentStyles, /notification-mark-all-read--compact \{[\s\S]*transition: width 240ms cubic-bezier\(0\.22, 1, 0\.36, 1\)/)
  assert.match(componentStyles, /notification-mark-all-read--compact-expanded \{[\s\S]*width: 144rpx;/)
  ...
  assert.match(componentStyles, /notification-mark-all-read--compact-expanded \.notification-mark-all-read__label \{[\s\S]*left: 0;[\s\S]*width: 100%;[\s\S]*max-width: none;[\s\S]*opacity: 1;[\s\S]*text-align: center;/)
