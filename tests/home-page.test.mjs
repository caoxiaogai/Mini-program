...
test('share gate hero adapts to the device width and keeps a 32px bottom inset', () => {
  ...
  assert.match(styles, /\.share-gate-page__hero\s*\{[\s\S]*flex:\s*1;[\s\S]*min-height:\s*0;/)
  assert.match(styles, /\.share-gate-page__hero\s*\{[\s\S]*padding:\s*0 20px 32px;/)
  assert.match(styles, /\.share-gate-page__content\s*\{[\s\S]*flex:\s*none;[\s\S]*padding:\s*32px 20px /)
  ...
  assert.match(markup, /share-gate-page__graphic/)
