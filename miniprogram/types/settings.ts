...
export const intentRuleSections: IntentRuleSection[] = [
  ...
  },
  {
    id: 'multi-image',
    label: '多图',
    body: '未看完所有图片为低意向，看完所有图片为中意向，查看2次及以上且至少1次看完所有图片、看完所有图片后又滑动看了前面的图片，或者转发1次及以上为高意向',
  },
  {
    id: 'pdf',
    label: 'PDF',
    body: '未看完为低意向，看完为中意向，查看2次及以上且至少1次看完、看完后又向上翻浏览之前的内容，或者转发1次及以上为高意向',
  },
  {
    id: 'note',
    label: '笔记',
  ...
  },
  {
    id: 'video',
    label: '视频',
    body: '播放进度低于80%为低意向，播放进度不低于80%为中意向，查看2次及以上且至少1次播放进度不低于80%、播放进度超过80%后又回退观看之前的内容，或者转发1次及以上为高意向',
  },
]
