...
- 首页「发布作品 / 待跟进」首屏移除原有顶部灰色和彩色渐变层，使用用户提供的本地主题图 `assets/home-new/home-theme-sunset.png`（1176×1116）作为最底层；其上覆盖 380px 高的白色渐变，顶部透明度 20%、底部透明度 100%，导航栏、标题与内容保持在主题层上方。主题图只有一个资源入口，后续可直接替换。
